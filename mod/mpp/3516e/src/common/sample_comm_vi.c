...
combo_dev_attr_t MIPI_CMOS_SENSOR_AR0130_12BIT_1M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_CMOS,
    .data_rate = MIPI_DATA_RATE_X1,
...
VI_DEV_ATTR_S DEV_ATTR_AR0130_1M_BASE =
{
    VI_MODE_DIGITAL_CAMERA,
    VI_WORK_MODE_1Multiplex,
    {0xFFF00000,    0x0},
...
VI_PIPE_ATTR_S PIPE_ATTR_1280x960_RAW12_420_3DNR_RFR =
{
    VI_PIPE_BYPASS_NONE, HI_FALSE, HI_FALSE,
    1280, 960,
    PIXEL_FORMAT_RGB_BAYER_12BPP,
...
VI_CHN_ATTR_S CHN_ATTR_1280x960_420_SDR8_LINEAR =
{
    {1280, 960},
    PIXEL_FORMAT_YVU_SEMIPLANAR_420,
    DYNAMIC_RANGE_SDR8,
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t *pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_AR0130_DC_1M_30FPS_12BIT:
            hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_CMOS_SENSOR_AR0130_12BIT_1M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;        
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_SC2235_DC_2M_30FPS_10BIT:
            ...
            break;
        case SMART_AR0130_DC_1M_30FPS_12BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_AR0130_1M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S *pstPipeAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_AR0130_DC_1M_30FPS_12BIT:
            hi_memcpy(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_1280x960_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S *pstChnAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_AR0130_DC_1M_30FPS_12BIT:
            hi_memcpy(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_1280x960_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
