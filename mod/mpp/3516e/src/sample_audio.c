...
#define CHIP_ID_HI3516EV200 0x3516e200
#define CHIP_ID_HI3518EV300 0x3518e300
...
HI_S32 SAMPLE_AUDIO_AiAenc(gsf_mpp_aenc_t *aenc)
{
    ...
    AENC_CHN    AeChn = 0;
    HI_BOOL     bSendAdec = (aenc)?HI_FALSE:HI_TRUE;
    FILE*        pfd = NULL;
    AIO_ATTR_S stAioAttr;
    g_enWorkSampleRate = aenc->sp;
    g_enSoundmode = aenc->stereo;
    g_u32ChnCnt = 1;//1<<aenc->stereo;
    ...
    stAioAttr.u32EXFlag      = 0;
    stAioAttr.u32FrmNum      = 30;
    stAioAttr.u32PtNumPerFrm = 160;//AACLC_SAMPLES_PER_FRAME;
    stAioAttr.u32ChnCnt      = g_u32ChnCnt;
    stAioAttr.u32ClkSel      = 1;
    stAioAttr.enI2sType      = AIO_I2STYPE_EXTERN;
#else
...
#endif
{
    ...
    if(CHIP_ID_HI3516EV200 == u32ChipId || CHIP_ID_HI3518EV300 == u32ChipId)
    {
        /* Hi3516EV200 only support mono input/output, Hi3518EV300 only support mono output */
